...
public class Firefox {
	...
	public static String getSize(By by) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		return isElementPresent(by) && driver.findElement(by).isDisplayed() ? driver.findElement(by).getRect().getDimension().toString().replace(", ", "x") : "null";
	}
	
	public static String getLocation(By by) {
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		return isElementPresent(by) && driver.findElement(by).isDisplayed() ? driver.findElement(by).getRect().getPoint().toString().replace(", ", "x") : "null";
	}
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < idElement.length; i++) {
			report.write((i + 1) + "," + browserName + ",index.php," + nameElement[i] + "," + isElementPresent(By.id(idElement[i])) + "," + valueElement[i] + "," + 
		            getSize(By.id(idElement[i])) + "," + getLocation(By.id(idElement[i])) + "\n");
			System.out.print((i + 1) + "," + browserName + ",index.php," + nameElement[i] + "," + isElementPresent(By.id(idElement[i])) + "," + valueElement[i] + "," + 
		            getSize(By.id(idElement[i])) + "," + getLocation(By.id(idElement[i])) + "\n");
		...
		for (int i = 0; i < idElement.length; i++) {
			report.write((i + 1 + idElement.length) + "," + browserName + ",confirmation.php," + nameElement[i] + "," + isElementPresent(By.id(idElement[i])) + "," + valueElement[i] + "," + 
		            getSize(By.id(idElement[i])) + "," + getLocation(By.id(idElement[i])) + "\n");
			System.out.print((i + 1 + idElement.length) + "," + browserName + ",confirmation.php," + nameElement[i] + "," + isElementPresent(By.id(idElement[i])) + "," + valueElement[i] + "," + 
		            getSize(By.id(idElement[i])) + "," + getLocation(By.id(idElement[i])) + "\n");
		}
